Aplicação desenvolvida com inspiração no software SCALE (Software for CALculating Emergy Based on Life Cicle Inventories), no intuito de avaliação do sétimo semestre do curso de Ciência da Computação.
